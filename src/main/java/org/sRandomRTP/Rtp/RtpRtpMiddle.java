...
public class RtpRtpMiddle {
    public static void rtpRtpmiddle(CommandSender sender, World targetWorld) {
        ...
        try {
            ...
            int radius = getWorldSpecificMiddleRadius(world, "radius-middle");
            int minRadius = getWorldSpecificMiddleRadius(world, "minradius-middle");
            ...
            if (radius > maxPossibleRadius) {
                if (loggingEnabled) {
                    Bukkit.getConsoleSender().sendMessage("[sRandomRTP-Middle] Radius " + radius + " exceeds world border size (" + (int)borderSize + "). Adjusting to " + maxPossibleRadius);
                }
            ...
            if (radiusAdjusted && loggingEnabled) {
                Bukkit.getConsoleSender().sendMessage("[sRandomRTP-Middle] Final adjusted values: radius=" + radius + ", minRadius=" + minRadius);
            }
    ...
    private static int getWorldSpecificMiddleRadius(World world, String setting) {
        String worldName = world.getName();
        String worldPath = "teleport-middle.per-world-middle." + worldName + "." + setting;
        if (Variables.middlefile.contains(worldPath)) {
            return Variables.middlefile.getInt(worldPath);
        }
        return Variables.middlefile.getInt("teleport-middle." + setting);
    }
