...
public class RtpRtpWorld {
    public static void rtpRtpworld(CommandSender sender, Player player, World targetWorld) {
        ...
        try {
            ...
            //if (!ensureCooldown(player, sender, loggingEnabled)) {
            //    return;
            //}
            ...
            if (radiusAdjusted && loggingEnabled) {
                Bukkit.getConsoleSender().sendMessage("[sRandomRTP] Final adjusted values for world '" + worldName + "': radius=" + radius + ", minRadius=" + minRadius);
            }
