...
import org.sRandomRTP.Cooldowns.CooldownBypassBossBarFar;
...
public class CommandFar {
    public static void commandFar(CommandSender sender) {
        try {
            ...
            if (!player.hasPermission("sRandomRTP.Command.Far")) {
            ...
            //
            if (CooldownBypassBossBarFar.cooldownBypassBossBarFar(player, sender, world)) {
                return;
            }
            return;
        } catch (Throwable e) {
